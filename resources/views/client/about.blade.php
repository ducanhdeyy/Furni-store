        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1>About Us</h1>
                    <p class="mb-4">{{$banner->description}} dolor tempor tristique.</p>
            ...
            <div class="col-lg-6">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            <div class="icon">
                                <img src="{{'template/client/images/return.svg'}}" alt="Image" class="imf-fluid">
                            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{asset('template/client/images/person_1.jpg')}}" class="img-fluid mb-5">
            ...
            <!-- Start Column 2 -->
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{asset('template/client/images/person_2.jpg')}}" class="img-fluid mb-5">
            ...
            <!-- Start Column 3 -->
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{asset('template/client/images/person_3.jpg')}}" class="img-fluid mb-5">
            ...
            <!-- Start Column 4 -->
            <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                <img src="{{asset('template/client/images/person_4.jpg')}}" class="img-fluid mb-5">
