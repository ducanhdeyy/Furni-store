            ...
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td width="180">
                        ...
                        @else
                            <select name="status" onchange="updateData({{ $order->id }})" id="{{ $order->id }}"
                                data-id="{{ $order->id }}" class="form-control statusOrder">
                                <option {{ $order->status == 1 ? 'selected' : '' }} value="1">wait for confirmation
                                </option>
